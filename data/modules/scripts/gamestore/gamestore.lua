		...
		offers = {
			{
				...
				itemtype = 43886,
                count = 1,
                description = "(critical hit chance 20%, critical extra damage +60%, life leech chance +100%, life leech amount +2%, mana leech chance +100%, mana leech amount +1%, magic level +10, protection ice +12%)",
			...
			},
			{
				...
				itemtype = 43881,
                count = 1,
                description = "(Arm:10, club fighting +10, sword fighting +10, axe fighting +10, distance fighting +10, protection all +7%).paladins and kinghts of level 100",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
			    icons = { "Amulet_Vip.png" },			
                name = "Broken Amulet", 
                price = 20, 
				itemtype = 3080,
                count = 1,
                description = "(Critical hit chance 10%, critical extra damage +25%, protection all +12%)",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 31616,
                count = 1,
                description = "(Arm:10, protection all +8%,).",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
			    icons = { "edlegs_vip.png" },			
                name = "Sanguine Legs", 
                price = 20, 
				itemtype = 43876,
                count = 1,
                description = "(Arm:10, magic level +10, protection all +7%). sorcerers and druids of level 100 ",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
			...
			{
			    icons = { "wand_vip.png" },			
                name = "Gran Sanguine Coil", 
                price = 15, 
				itemtype = 43883,
                count = 1,
                description = "(critical hit chance 20%, critical extra damage +60%, life leech chance +100%, life leech amount +2%, mana leech chance +100%, mana leech amount +1%, magic level +7, protection death +12%).",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
			...
			},
			{
				...
				itemtype = 43880,
                count = 1,
                description = "(Range: 7, Atk +100, Hit% +80, distance fighting +7, critical hit chance 30%, critical extra damage +80%, protection death +7%).",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 43878,
                count = 1,
                description = "(Range: 7, Atk +80, Hit% +50, distance fighting +7, critical hit chance 20%, critical extra damage +50%, protection holy +7%).",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 43869,
                count = 1,
                description = "(Atk:40 physical + 60 ice, Def:32 +3, axe fighting +7, critical hit chance 20%, critical extra damage +50%, life leech chance +100%, life leech amount +1%, mana leech chance +100%, mana leech amount +1%).",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 43865,
                count = 1,
                description = "(Atk:40 physical + 60 ice, Def:32 +3, sword fighting +7, critical hit chance 20%, critical extra damage +50%, life leech chance +100%, life leech amount +1%, mana leech chance +100%, mana leech amount +1%).",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 43867,
                count = 1,
                description = "(Atk:40 physical + 60 ice, Def:32 +3, club fighting +7, critical hit chance 20%, critical extra damage +50%, life leech chance +100%, life leech amount +1%, mana leech chance +100%, mana leech amount +1%)",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 43887,
                count = 1,
                description = "(Arm:10, magic level +5, protection all +7%, speed +45). paladins and kinghts of level 100",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 43884,
                count = 1,
                description = "(Arm:10, magic level +10, protection all +7%, speed +45)..sorcerers and druids of level 100",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
				...
				itemtype = 19369,
                count = 1,
                description = "(critical hit chance 10%, critical extra damage +30%, protection all +7%).",
                type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				moveable = true
			},
			{
